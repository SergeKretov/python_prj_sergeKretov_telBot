...
def message_handler(bot:Bot, update:Update):
    ...
    if text == '/start':
        ...
        txt10 = '📆Записаться на прием - /app'
        txt11 = '📚Узнать цены - /price'
        txt12 = '💸Подробнее о банкротстве - /bank'
        txt13 = '📖Посетить сайт агентства - /web'
        txt14 = '🖥Войти в кабинет клиента - /client'
        txt15 = '📰Получить краткую информацию о нас - /info'
        txt16 = '📲Написать в личку Сергею Сергеевичу - /serge'
